                    ...
                    <div className="mt-10">
                        ...
                        <div className="mt-8">
                            <button
                                ...
                                disabled={isLoading}
                                className={`flex w-full items-center justify-center gap-3 rounded-2xl bg-white dark:bg-white/5 px-4 py-4 text-xs font-black text-slate-900 dark:text-white shadow-sm ring-1 ring-inset ring-slate-200 dark:ring-white/10 hover:bg-slate-50 dark:hover:bg-white/10 transition-all uppercase tracking-widest ${isLoading ? 'opacity-50 cursor-not-allowed' : 'hover:-translate-y-0.5'}`}
                            >
